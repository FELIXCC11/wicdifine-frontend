...
export const WICFINAvatarLogo = ({ size = 28, className = "" }: InterProps) => {
  return (
    <div className={cn("flex items-center justify-center w-full h-full", className)}>
      <img
        ...
        style={{
          width: `${Math.floor(size * 0.75)}px`, // Use 75% of container size for better visual balance
...
export const WICFINLogo = ({ size = 24, className = "" }: InterProps ) => {
  return (
    <img
      src="/WICFINlogo.svg"
      alt="WICFIN"
...
export const WICCHAINLogo = ({ size = 16, className }: InterProps) => {
  return (
    <img
      src="/WICCHAIN.svg"
      alt="WICCHAIN"
...
export const BotIcon = () => {
  ...
  export const AlertTriangle = ({ size = 16, className }: { size?: number; className?: string }) => {
    return (
      <svg
        height={size}
        strokeLinejoin="round"
  ...
  export const FileText = ({ size = 16, className }: { size?: number; className?: string }) => {
    return (
      <svg
        height={size}
        strokeLinejoin="round"
