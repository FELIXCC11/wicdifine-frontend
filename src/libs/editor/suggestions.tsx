// src/libs/editor/suggestions.tsx
...
import { Suggestion as PreviewSuggestion } from '../../components/text-editor';
...
function findPositionsInDoc(doc: Node, searchText: string): Position | null {
  ...
  doc.nodesBetween(0, doc.content.size, (node: Node, pos: number) => {
...
export const suggestionsPlugin = new Plugin<SuggestionPluginState>({
  ...
  state: {
    ...
    apply(tr: any, state: SuggestionPluginState): SuggestionPluginState {
